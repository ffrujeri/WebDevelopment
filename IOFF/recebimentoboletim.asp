...
Repeat1__numRows = -1
Repeat1__index = 0
registro_numRows = registro_numRows + Repeat1__numRows
%>
<html>
...
function mmLoadMenus() {
  ...
  mm_menu_1115101523_0.addMenuItem("Dentística&nbsp;e&nbsp;Prótese");
...
window.mm_menu_1115105914_0 = new Menu("root",92,17,"Verdana, Arial, Helvetica, sans-serif",11,"#FFFFFF","#336699","#205CA5","#FFFFFF","left","middle",3,0,200,-5,7,true,true,true,0,true,true);
  ...
  mm_menu_1115111130_0.addMenuItem("Dentística&nbsp;e&nbsp;Prótese","window.open('artigos_dentistica.htm', '_parent');");
...
WriteDate()
          ...
          <tr>
            ...
            <td valign="top" align="left" width="445" height="776"> <p style="word-spacing: 0; line-height: 100%; margin-top: 0; margin-bottom: 0"><font size="1" face="arial"><a href="principal.htm">Instituto 
              ...
              <% 
While ((Repeat1__numRows <> 0) AND (NOT registro.EOF)) 
%>
              <p align="left" style="word-spacing: 0; line-height: 100%;"><font color="#205CA5" size="1" face="arial black"> 
                </font><font color="#205CA5" size="1" face="Arial, Helvetica, sans-serif"><br>
                NOME: <%=(registro.Fields.Item("nome").Value)%><br>
                E-MAIL:</font><font color="#205CA5" face="arial"><font color="#336699" size="1" face="arial black"> 
                <%=(registro.Fields.Item("email").Value)%> <br>
                <font face="arial"> ENDERE&Ccedil;O: <%=(registro.Fields.Item("endereco").Value)%><br>
                CIDADE: <%=(registro.Fields.Item("cidade").Value)%><br>
                ESTADO: <%=(registro.Fields.Item("estado").Value)%><br>
                PROFISS&Atilde;O: <%=(registro.Fields.Item("profissao").Value)%> </font></font></font> 
              <hr>
              <p align="left" style="word-spacing: 0; line-height: 100%;"><font color="#205CA5" face="arial"><font color="#336699" size="1" face="arial black"><font face="arial"> 
                <br>
                </font></font></font><br>
                <br>
                <br>
...
<font face="arial" size=1 color=#205CA5><B>Qual é o seu maior receio no
...
</td><td width="125"><font size="1" face="Arial" color="#205CA5">Alta-rotaçao (motorzinho)</font> 
</td></tr>
<tr valign=middle><td width="25">
...
</td><td width="125"><font size="1" face="Arial" color="#205CA5">Não tenho receio</font> 
</td></tr>
