...
PT-BR;mso-bidi-language:AR-SA">&nbsp;&nbsp;<span style="color:#205CA5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              você deseja receber nosso boletim com novidades, informações e
              atualizações do nosso portal, preencha os campos abaixo com seus
              dados.<br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Preste muita atenção
              no preenchimento: escreva corretamente o seu e-mail, pois é por
              este endereço que nós entraremos em contato com você.</span></font><p align="center" style="word-spacing: 0; line-height: 100%;"><font color="#336699" size="1" face="arial black"><img src="principal/img/rc_cadastro.gif" width="445" height="15"></font> 
              <form ACTION="<%=MM_editAction%>" method="POST" name="formulario" id="formulario" onSubmit="MM_validateForm('nome','','R','email','','RisEmail','endereco0','','R','cidade','','R','profissao','','R');return document.MM_returnValue">
                ...
                <table width="457" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="65"><font size="1" face="Arial, Helvetica, sans-serif" color="#205CA5">PROFISSÃO:</font></td>
